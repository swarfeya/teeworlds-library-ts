...
var messageTypes = [
	["none, starts at 1", "SV_MOTD", "SV_BROADCAST", "SV_CHAT", "SV_KILL_MSG", "SV_SOUND_GLOBAL", "SV_TUNE_PARAMS", "SV_EXTRA_PROJECTILE", "SV_READY_TO_ENTER", "SV_WEAPON_PICKUP", "SV_EMOTICON", "SV_VOTE_CLEAR_OPTIONS", "SV_VOTE_OPTION_LIST_ADD", "SV_VOTE_OPTION_ADD", "SV_VOTE_OPTION_REMOVE", "SV_VOTE_SET", "SV_VOTE_STATUS", "CL_SAY", "CL_SET_TEAM", "CL_SET_SPECTATOR_MODE", "CL_START_INFO", "CL_CHANGE_INFO", "CL_KILL", "CL_EMOTICON", "CL_VOTE", "CL_CALL_VOTE", "CL_IS_DDNET", "SV_DDRACE_TIME", "SV_RECORD", "UNUSED", "SV_TEAMS_STATE", "CL_SHOW_OTHERS_LEGACY", "SV_MYOWNMESSAGE", "CL_SHOWDISTANCE", "CL_SHOWOTHERS", "CL_CAMERAINFO", "SV_TEAMSSTATE", "SV_DDRACETIME", "SV_RECORD", "SV_KILLMSGTEAM", "SV_YOURVOTE", "SV_RACEFINISH", "SV_COMMANDINFO", "SV_COMMANDINFOREMOVE", "SV_VOTEOPTIONGROUPSTART", "SV_VOTEOPTIONGROUPEND", "SV_COMMANDINFOGROUPSTART", "SV_COMMANDINFOGROUPEND", "SV_CHANGEINFOCOOLDOWN", "SV_MAPSOUNDGLOBAL", "SV_PREINPUT", "SV_SAVECODE", "SV_SERVERALERT", "SV_MODERATORALERT", "CL_ENABLESPECTATORCOUNT"],
